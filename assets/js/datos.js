window.VetLifeDatos = {
  ...
  servicios: [
    { id:'S-01', nombre:'Consulta General', categoria:'Medicina Interna', duracion:30, precio:40, activo:true, icono:'bi-heart-pulse' },
    { id:'S-02', nombre:'Consulta Especializada', categoria:'Medicina Interna', duracion:45, precio:55, activo:true, icono:'bi-person-badge' },
    { id:'S-03', nombre:'Ecografía Abdominal', categoria:'Imagen', duracion:30, precio:45, activo:true, icono:'bi-soundwave' },
    { id:'S-04', nombre:'Radiografía Digital', categoria:'Imagen', duracion:20, precio:35, activo:true, icono:'bi-camera' },
    { id:'S-05', nombre:'Tomografía Computada', categoria:'Imagen', duracion:60, precio:180, activo:true, icono:'bi-bounding-box-circles' },
    { id:'S-06', nombre:'Resonancia Magnética', categoria:'Imagen', duracion:90, precio:250, activo:false, icono:'bi-radioactive' },
    { id:'S-07', nombre:'Hemograma Completo', categoria:'Laboratorio', duracion:120, precio:20, activo:true, icono:'bi-droplet' },
    { id:'S-08', nombre:'Bioquímica Sérica', categoria:'Laboratorio', duracion:180, precio:30, activo:true, icono:'bi-eyedropper' },
    { id:'S-09', nombre:'Uroanálisis', categoria:'Laboratorio', duracion:60, precio:15, activo:true, icono:'bi-cup' },
    { id:'S-10', nombre:'Cultivo Bacteriano', categoria:'Laboratorio', duracion:2880, precio:50, activo:true, icono:'bi-virus' },
    { id:'S-11', nombre:'Ecocardiografía', categoria:'Cardiología', duracion:45, precio:95, activo:true, icono:'bi-heart' },
    { id:'S-12', nombre:'Electrocardiograma', categoria:'Cardiología', duracion:20, precio:40, activo:true, icono:'bi-activity' },
    { id:'S-13', nombre:'Limpieza Dental', categoria:'Odontología', duracion:40, precio:70, activo:true, icono:'bi-emoji-smile' },
    { id:'S-14', nombre:'Extracción Dental', categoria:'Odontología', duracion:45, precio:50, activo:true, icono:'bi-emoji-smile' },
    { id:'S-15', nombre:'Castración / Esterilización', categoria:'Cirugía', duracion:60, precio:120, activo:true, icono:'bi-scissors' },
    { id:'S-16', nombre:'Cirugía de Tejidos Blandos', categoria:'Cirugía', duracion:120, precio:200, activo:true, icono:'bi-bandaid' }
  ],
  pacientesDemo: [
